...
public class ItemRequestController {
    ...
    @GetMapping
    public List<ItemRequestWithInfoDto> getRequestsByOwner(@RequestHeader(USER_ID_HEADER) long ownerId) {
    ...
    public ItemRequestWithInfoDto getRequestById(@PathVariable("requestId") long requestId) {
